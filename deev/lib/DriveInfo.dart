                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Column(
                              ...
                              children: <Widget>[
                                Icon(Icons.thumb_up,size: 20,color: Colors.black,), Divider(height: 5,color: Colors.black,),
                                Text('145',style: TextStyle(fontSize: 16))
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: <Widget>[
                                Icon(Icons.thumb_down,size: 20,color: Colors.black,),
